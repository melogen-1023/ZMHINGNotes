...
not until : 瞬间动词，翻译为直到...才做...（在之前是未做）

until : 连续动词（翻译为直到...之前一直是...）



**when引导的时间状语从句，如果主句的主语和从句的一致，并且从句的谓语中有be动词，此时从句的主语和be动词可以省略**
...
* 否定词放在句首用倒装（否定词提前，主谓要变成一般疑问句）
* so，nor/neither位于句首，表明承前句子的肯定或否定时用倒装
* so...that...（将so引导的部分置于句首时用倒装）
* only引出的状语位于句首用倒装
* as引导让步状语从句
* 省略if的虚拟语气用倒装
...
虚拟语气表示委婉，需要时态往后退一个时态（过去时变成过去完成时）

虚拟语气中没有was只有were

could = would = might（后面要跟动词原形，主句不能用过去时，要用现在完成时）
